...
use Perseus\System\SystemInstaller;
...
class RegistrationSystemInstaller extends SystemInstaller {
  ...
  private $install = array('flood', 'registration');
  ...
  public function schema($table) {
    // Call the parent to see if it can populate the schema for this table.
    $schema[$table] = parent::schema($table);
    // Now add the schema that this object is responsible for.
